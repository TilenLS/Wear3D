...
class Ui_RegisterPage(object):
    def setupUi(self, MainWindow):
        ...
        self.register_account_label.setGeometry(QtCore.QRect(0, 80, 1200, 100))
        ...
        self.confirm_password_input.setGeometry(QtCore.QRect(350, 520, 500, 70))
