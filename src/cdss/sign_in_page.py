...
class Ui_SignInPage(object):
    def setupUi(self, MainWindow):
        ...
        self.account_login_label.setMinimumWidth(400)
        ...
        self.vertical_layout.addWidget(self.account_login_label, 1, 0, Qt.AlignHCenter | Qt.AlignTop)
        ...
        self.vertical_layout.addWidget(self.no_account_yet_text, 5, 0, Qt.AlignHCenter | Qt.AlignBottom)
